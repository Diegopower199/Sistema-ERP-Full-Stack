...
import FormDetallesFacturasClientes from "./FormDetallesFacturasClientes";

export default function DetallesFacturasClientes() {
  const {
    authUser,
    setAuthUser,
    isLoggedIn,
  ...
  const renderTableVacacionEmpleado = () => {
    ...
    return (
      <div>
        <h1>Detalles Facturas Clientes</h1>
        <h2>
          <Link href={"/facturacion"}>Menu Facturacion</Link>
        </h2>
        <Box
          sx={{
            height: 700,
