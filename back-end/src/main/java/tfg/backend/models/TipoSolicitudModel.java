...
@Table(name = "tipos_solicitudes", uniqueConstraints = {
        @UniqueConstraint(name = "UK_tipo_solicitud", columnNames = "tipo_solicitud"), })
@Entity
@ToString
@Data
@Getter
...
public class TipoSolicitudModel implements Serializable {
    ...
    @JsonIgnore
    @OneToMany(mappedBy = "tipo_solicitud", cascade = CascadeType.REMOVE)
