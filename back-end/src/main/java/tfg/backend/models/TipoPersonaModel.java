...
@Table(name = "tipos_personas", uniqueConstraints = {
        @UniqueConstraint(name = "UK_tipo_persona", columnNames = "tipo_persona"), })
@Entity
@ToString
@Data
@Getter
...
public class TipoPersonaModel implements Serializable {
    ...
    @JsonIgnore
    @OneToMany(mappedBy = "tipo_persona", cascade = CascadeType.REMOVE)
